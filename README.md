...
Figure 1B
Functional connectivity matrix for the array Z_fmriprep_9p_avg_rearr (ROI x ROI) in rearranged_matrices.mat
This data is from the array Z_fmriprep_9p_avg (ROI x ROI) reorganized according to labels produced from the script louv_comm_det_iteration_fmriprep_9p.m
...
- the fmriprep_9p_pos_links_358.csv (ROI x ROI) datafile contains the average functional connectivity matrix from Z_fmriprep_9p_avg
...
Figure 3
Functional connectivity matrix for the array Z_fmriprep_9p_PMAT_avg_rearr (ROI x ROI) in rearranged_matrices.mat
...
The arrays that correspond to the tsnr are labelled WashU_tsnr (ROI x tSNR value) and UCD_tsnr (ROI x tSNR value)
...
data for this figure can be found in supplemental_path_length_data.mat in the array SPL_DMN (subject x network x network)
...
data for this figure can be found in supplemental_path_length_data.mat in the array SPL_hipp (subject x network x network)
